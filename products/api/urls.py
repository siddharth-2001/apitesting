...
from .views import get_email,list_all_products, create_product, view_product, purchase_product, add_review, get_all_review, delete_product, rate_product
...
urlpatterns = [
    ...
    path('api', get_email, name='api_view')
